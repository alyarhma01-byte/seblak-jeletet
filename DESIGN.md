...
colors:
  /* CSS HEX */
--pure-red: #F40303ff;
--brick-ember: #BF0103ff;
--forest-green: #03913Fff;
--primary-scarlet: #DC0F11ff;
--bright-amber: #FECB01ff;

    /* CSS HSL */
--pure-red: hsla(0, 98%, 48%, 1);
--brick-ember: hsla(359, 99%, 38%, 1);
--forest-green: hsla(145, 96%, 29%, 1);
--primary-scarlet: hsla(359, 87%, 46%, 1);
--bright-amber: hsla(48, 99%, 50%, 1);
...
$bright-amber: hsla(48, 99%, 50%, 1);
    ...
    /* SCSS RGB */
$pure-red: rgba(244, 3, 3, 1);
$brick-ember: rgba(191, 1, 3, 1);
$forest-green: rgba(3, 145, 63, 1);
$primary-scarlet: rgba(220, 15, 17, 1);
$bright-amber: rgba(254, 203, 1, 1);

    /* SCSS Gradient */
$gradient-top: linear-gradient(0deg, #F40303ff, #BF0103ff, #03913Fff, #DC0F11ff, #FECB01ff);
$gradient-right: linear-gradient(90deg, #F40303ff, #BF0103ff, #03913Fff, #DC0F11ff, #FECB01ff);
$gradient-bottom: linear-gradient(180deg, #F40303ff, #BF0103ff, #03913Fff, #DC0F11ff, #FECB01ff);
$gradient-left: linear-gradient(270deg, #F40303ff, #BF0103ff, #03913Fff, #DC0F11ff, #FECB01ff);
$gradient-top-right: linear-gradient(45deg, #F40303ff, #BF0103ff, #03913Fff, #DC0F11ff, #FECB01ff);
$gradient-bottom-right: linear-gradient(135deg, #F40303ff, #BF0103ff, #03913Fff, #DC0F11ff, #FECB01ff);
$gradient-top-left: linear-gradient(225deg, #F40303ff, #BF0103ff, #03913Fff, #DC0F11ff, #FECB01ff);
$gradient-bottom-left: linear-gradient(315deg, #F40303ff, #BF0103ff, #03913Fff, #DC0F11ff, #FECB01ff);
$gradient-radial: radial-gradient(#F40303ff, #BF0103ff, #03913Fff, #DC0F11ff, #FECB01ff);
